...
struct EblockOptions
{
    ...
    // constructor
    EblockOptions() : strainsFileName(NULL), blocksFileName(NULL), blockSNPsFileName(NULL), minBlockSNPs(4)
    {};
};
...
EblockOptions *parseEblockOptions(int argc, char **argv)
{
    ...
    const char *usage = "Usage: eblocks [options]\n"
                        "\nRequired arguments:\n" 
                        "    -s, --strains                 <name of strains file> same file with (haplomap ghmap -p)\n"
                        "    -a, --alleles                 <name of alleles file> output file generated by (haplomap convert) \n"
                        "    -g, --genes                   <name of SNPs-to-genes annotation file> output file generated by (haplomap annotate)\n"
                        "    -o, --output                  <haploblocks file for (haplomap ghmap -b)>\n"
                        "\nOptional arguments:\n"                       
                        "    -p, --block-variant           <haploblocks file with variants coordinates>. used for prioritize variants by locations\n"
                        "    -m, --minblock-variant        minimum snps per block. default 3\n"
                        "    -n, --non-overlapping         run non-overlapping haplobock finding algorthim\n" 
                        "    -v, --verbose\n"
                        "    -h, --help\n";
